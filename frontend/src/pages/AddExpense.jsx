...
const AddExpense = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!previewUrl) {
      alert("Please upload or capture a receipt image");
      return;
    }

    if (!formData.description || !formData.amount || !formData.vendor || !formData.payment_method) {
    ...
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 pb-32">
        <div className="bg-white p-5 sm:p-8 rounded-xl shadow-sm ring-1 ring-slate-200">
          ...
          {/* Step 1: Upload */}
          <div className="mb-8">
            <label className="block text-sm font-medium text-slate-900 mb-3">Receipt / Bill <span className="text-red-500">*</span></label>
